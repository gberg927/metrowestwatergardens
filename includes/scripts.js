...
var initPhotoSwipeFromDOM = function(gallerySelector) {
    ...
    var parseThumbnailElements = function(el) {
        ...
        var thumbElements = document.querySelectorAll(gallerySelector)[0].getElementsByTagName('figure'),
            numNodes = thumbElements.length,
            items = [],
            figureEl,
            linkEl,
    ...
    var onThumbnailsClick = function(e) {
        ...
        var clickedGallery = document.querySelectorAll(gallerySelector)[0],
            childNodes = document.querySelectorAll(gallerySelector)[0].getElementsByTagName('figure'),
            numChildNodes = childNodes.length,
            nodeIndex = 0,
            index;
